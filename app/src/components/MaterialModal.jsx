...
const labelClass =
  'block text-[12px] font-medium text-[var(--fg2)] mb-1.5'
        ...
        <>
          {isEdit && (
            <button
              ...
              className="rounded-full px-3 py-2 text-[14px] font-medium hover:bg-[var(--hover)] transition"
          ...
          <button
            type="button"
            onClick={onClose}
            className="ml-auto rounded-full border border-[var(--line)] px-4 py-2 text-[14px] font-medium text-[var(--fg)] hover:bg-[var(--hover)] transition"
          >
            Anuluj
          </button>
          <button
            type="submit"
            form="material-form"
            className="rounded-full bg-[var(--fg)] px-5 py-2 text-[14px] font-medium text-[var(--surface)] hover:opacity-85 transition"
          >
            Zapisz
          </button>
        </>
